...
import nl.wittig.net2grid.api.responses.ResultSetResponse;
import nl.wittig.net2grid.helpers.PersistentHelper;
import nl.wittig.net2grid.helpers.WifiHelper;
import nl.wittig.net2grid.liveUsage.fragments.EnergyDayBarChartFragment;
import nl.wittig.net2grid.liveUsage.fragments.EnergyMonthBarChartFragment;
import nl.wittig.net2grid.liveUsage.fragments.EnergyYearBarChartFragment;
import nl.wittig.net2grid.liveUsage.fragments.GasDayBarChartFragment;
import nl.wittig.net2grid.liveUsage.fragments.GasMonthBarChartFragment;
import nl.wittig.net2grid.liveUsage.fragments.GasYearBarChartFragment;
import nl.wittig.net2grid.liveUsage.fragments.LiveBarChartFragment;
import nl.wittig.net2grid.liveUsage.fragments.LiveChartFragment;
import nl.wittig.net2grid.liveUsage.fragments.LiveLineChartFragment;
import nl.wittig.net2grid.liveUsage.fragments.LiveUsageMenu;
import nl.wittig.net2grid.liveUsage.fragments.PowerDayLineChartFragment;
import nl.wittig.net2grid.liveUsage.fragments.PowerHourLineChartFragment;
...
public class LiveUsageActivity extends AppCompatActivity implements LiveChartFragment.ReadyListener, ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuFragment = (LiveUsageMenu) getSupportFragmentManager().findFragmentById(R.id.activity_live_usage_menu);
...
//          This is the standard viewpager
        liveChartPagerAdapter = new LiveChartPagerAdapter(getSupportFragmentManager(), configurationFragments);
